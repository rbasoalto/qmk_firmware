 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   F  |   P  |   G  | Caps |           | Caps |   J  |   L  |   U  |   Y  |  ;:  |   -_   |
 * |--------+------+------+------+------+------| Lock |           | Lock |------+------+------+------+------+--------|
 * | LCtrl  |   A  |   R  |   S  |   T  |   D  |------|           |------|   H  |   N  |   E  |   I  |   O  |   '"   |
 * |--------+------+------+------+------+------| LCmd |           | RCmd |------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |      |           |      |   K  |   M  |  ,<  |  .>  |  /?  | RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Del  | Del  | ~L2  | ~L1  | LAlt |                                       | RAlt | ~L2  |  [{  |  ]}  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Left | Right|       |  Up  | Down |
 *                                 ,------|------|------|       |------+------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_TAB,     KC_Q,       KC_W,       KC_F,       KC_P,       KC_G,       KC_CAPS,
        KC_LCTRL,   KC_A,       KC_R,       KC_S,       KC_T,       KC_D,
        KC_LSFT,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_LGUI,
        KC_DEL,     KC_DEL,     KC_FN2,     KC_FN1,     KC_LALT,
                                                                    KC_LEFT,    KC_RIGHT,
                                                                                KC_HOME,
                                                        KC_SPC,     KC_BSPC,    KC_END,
        // right hand
        KC_BSLS,    KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       KC_EQL,
        KC_CAPS,    KC_J,       KC_L,       KC_U,       KC_Y,       KC_SCLN,    KC_MINUS,
                    KC_H,       KC_N,       KC_E,       KC_I,       KC_O,       KC_QUOT,
        KC_RGUI,    KC_K,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT,
                                KC_RALT,    KC_FN2 ,    KC_LBRC,    KC_RBRC,    KC_FN1,
        KC_UP,      KC_DOWN,
        KC_PGUP,
...
// MEDIA AND MOUSE
[MDIA] = KEYMAP(
       KC_EJCT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
